...
BULLET_HIT_SOUND = pygame.mixer.Sound('Assets/Blazer.wav')
BULLET_FIRE_SOUND = pygame.mixer.Sound('Assets/Grenade_Knova.wav')

BORDER_COLOR = (0, 0, 0)
RED_BULLET_COLOR = (255, 51, 0)
YELLOW_BULLET_COLOR = (255, 163, 26)
WHITE = (255, 255, 255)
